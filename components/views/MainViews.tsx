...
// ═══════════════════════════════════════════════════════════════════════════════
export function ChangePasswordView({ profile, onSuccess }: { profile: UserProfile; onSuccess: () => void }) {
...
// ═══════════════════════════════════════════════════════════════════════════════
export function VisitsLog({ profile }: { profile: UserProfile }) {
...
export function MeasurementBox({ label, value, suffix, icon }: { label: string; value: any; suffix: string; icon: React.ReactNode }) {
  return (
...
// ═══════════════════════════════════════════════════════════════════════════════
export function DepartmentsUnitsView({ profile }: { profile: UserProfile }) {
...
// ── Helper Components ──────────────────────────────────────────────────────────
export function InfoChip({ label, value, full }: { label: string; value: string; full?: boolean }) {
  return (
...
export function MeasureInput({ label, value, onChange, placeholder }: {
